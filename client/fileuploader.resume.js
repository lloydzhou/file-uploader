...
qq.backupUpload = function(className, upload){
    qq.extend(qq[className].prototype, {
        _upload_old: qq[className].prototype._upload, 
...
qq.backupUpload('UploadHandlerXhr', function(id, params, part){
